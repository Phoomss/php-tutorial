        ...
        <a href="#" onclick="confirmLogout()">Logout</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#">Welcome, Admin <?php echo $_SESSION['userInfo']['username']; ?></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <p>Welcome to the admin dashboard. You can manage users, settings, and view reports here.</p>
                <div class="card mt-4">
